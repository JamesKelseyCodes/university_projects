...
public class Monster extends GameCharacter
{
    ...
    *
    *@param name        String which specifies the monsters.txt name
    *@param health      int which sets the monsters.txt health
    *@param minDamage   int which sets the monsters.txt minDamage
    *@param maxDamage   int which sets the monsters.txt maxDamage
    */
