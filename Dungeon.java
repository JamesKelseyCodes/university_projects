...
public class Dungeon
{
    ...
    */
    ...
    /**
    *Method which facilitates the attack sequence for both the player and the monsters.txt
    *
    ...
    */
    ...
    /**
    *Method which generates the ArrayList of monsters.txt based on the Difficulty setting
    *
    *@param numMonsters an int which determines the length of the monsters.txt ArrayList
    */
    public void createMonsters(int numMonsters)
    {
        ...
        for (int i = numMonsters; i > 0; i--) // i like to decrement because it's conceptually easier to see that you stop at 0 
        {
            ...
            catch (Exception e)
            {
                ...
                i++;
                j++;
                // if there are more than 10 errors then the monsters.txt file is probably very broken so program exits and displays the errors including the lines in the file that caused the errors.
                if (j >= 10)
                {
        ...
        // if the program doesn't generate the right number of monsters.txt program will exit
        if (!(numMonsters == monsters.size()))
        {
            System.out.println("Something went wrong generating monsters.txt, exiting game");
            System.exit(1);
        }
    }
    ...
    */
    ...
    /**
    *Method which returns the details of each monster in the monsters.txt ArrayList
    *
    *@return dispMon a string which contains the details of each of the monsters.txt on the ArrayList
    */
    ...
    */
    public void eventLauncher(Player player)
    {
        ...
        // additional condition to allow if statement to fall to "nothing happens" if no more monsters.txt, rather than just letting it run and exit
    ...
    */
    ...
    /**
    *Accessor Method to return the collection of monsters.txt
    *
    *@return monsters.txt an ArrayList<Monster> containing all the monsters.txt
    */
    ...
    */
    ...
    /**
    *Method which chooses the last monster of the monsters.txt ArrayList if there is one
    *
    ...
    */
    ...
    {
        //check that there are monsters.txt left in the ArrayList
    ...
    */
    ...
    /**
    *Mutator Method which replaces a monster at the index position in the monsters.txt ArrayList
    *
